...
//        webView.evaluateJavascript(Util.getStringFromAsset("xevent/XPTracker.js", mContext), null);
//        webView.evaluateJavascript(Util.getStringFromAsset("xevent/XPStashTracker.js", mContext), null);
//        webView.evaluateJavascript(Util.getStringFromAsset("xevent/XPEvent.js", mContext), null);
//        webView.evaluateJavascript(Util.getStringFromAsset("xevent/XPStream.js", mContext), null);
//        webView.evaluateJavascript(Util.getStringFromAsset("xevent/XPRegisterTrackers.js", mContext), null);
//        webView.evaluateJavascript(Util.getStringFromAsset("xevent/XPEventManager.js", mContext), null);
